...
var script$6 = {
    ...
    methods: {
        ...
        bindDocumentEditListener() {
            ...
            //         if (!this.selfClick) {
            //             console.log('running complete edit');
            //             this.completeEdit(event, 'outside');
            //         }

            //         console.log('document edit listener - set to false');
            //         this.selfClick = false;
            //     };
            ...
            if (!this.documentEditListener) {
                ...
                this.mouseUpListener = (event) => {
                    // console.log('running mouseUp')
                    if (!drag && !this.selfClick) {
                        this.completeEdit(event, 'outside');
                        document.removeEventListener('click', this.mouseUpListener);
                    }
                ...
                this.documentEditListener = (event) => {
                    ...
                    document.addEventListener('click', this.mouseUpListener);
                    this.selfClick = false;
                };
        ...
        onClick(event) {
            if (this.editMode === 'cell' && this.isEditable()) {
                // console.log('onClick - set to true');
                this.selfClick = true;
